...
\begin{definition}
	...
	\]
	\(\widetilde{f}(\omega ) \) descrive la componente di \(e^{i \omega t}\) nella funzione di partenza. La \(f(t)\) è rappresentabile come sovrapposizione continua di fasori tramite l'antitrasformata di Fourier:
	\begin{equation}
		f(t)=\frac{1}{2\pi } \int_{-\infty}^{\infty} \widetilde{f} (\omega ) e^{i \omega t} \,\mathrm{d}\omega  
	\end{equation}
\end{definition}
...
\begin{itemize}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{screenshots/2024-03-07-09-40-06.png}
	\end{figure}
	
	\item Le derivate diventano moltiplicazioni, come già visto con i fasori:
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.65\textwidth]{screenshots/2024-03-07-09-41-51.png}
	\end{figure}
\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{screenshots/2024-03-07-09-46-30.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{screenshots/2024-03-07-09-48-28.png}
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{screenshots/2024-03-07-09-51-21.png}
...
\begin{note}
	...
	\begin{itemize}
		\item Trovata spesso in ambito fisico o matematico:
		\begin{align}
			\widetilde{f} (\omega )&=\frac{1}{\sqrt{2\pi } }\int_{-\infty}^{\infty} f(t)e^{-i \omega t} \,\mathrm{d}t
			&
			f(t)&=\frac{1}{2\pi }\int_{-\infty}^{\infty} \widetilde{f} (\omega ) e^{i \omega t} \,\mathrm{d} \omega  
		\end{align}
		\item Trovata spesso in ambito ingegneristico, ponendo \(\nu = \quotient{\omega }{2 \pi } \):
		\begin{align}
...
L'equazione appena ricavata è molto importante. Per iniziare, considereremo casi in cui \(\mu \) è costante. È detta equazione di D'Alembert. Per ricordarci che \(\frac{\mu }{T}\) è una quantità positiva, la scriviamo come il quadrato di una quantità. Notiamo che ha le dimensioni dell'inverso di una velocità: \(\frac{\mu }{T} = \frac{1}{v^{2} } \to v=\sqrt{\frac{T}{\mu }} \).
