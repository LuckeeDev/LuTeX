...
\newcommand{\thelecture}{}%
\newcommand{\lecture}[2]{
    \renewcommand{\thelecture}{Lezione #1: #2}%
    \section*{\thelecture}%
}
\usepackage{pgffor}%
\newcommand{\lec}[2]{%
...
\fancypagestyle{fancy}{%
    \fancyhf{}%
    \fancyhead[LE]{\textbf{\thepage}\hskip4mm\leftmark}%
    \fancyhead[RO]{\nouppercase{\rightmark}\hskip4mm\textbf{\thepage}}%
...
% begin appendix autore patch [\autoref subsections in appendix](https://tex.stackexchange.com/questions/149807/autoref-subsections-in-appendix)
\makeatletter
