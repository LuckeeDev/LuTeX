\chapter{Topologia negli spazi metrici}\label{chap:topology}

\section{Elementi di topologia}

\begin{definition}[Spazio metrico]\label{def:distance}
...
\begin{definition}
    [Distanza di un punto da un insieme]\label{def:d_point_set}
...
\begin{theorem}
    [di Bolzano-Weierstrass]\label{thm:BW}
...
\begin{definition}
    [Convergenza uniforme]\label{def:unif_conv}
